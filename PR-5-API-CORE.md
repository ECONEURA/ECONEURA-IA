...
**PR-5** implementa el núcleo de la API con Express.js, incluyendo servidor, rutas, controladores, middleware y endpoints básicos siguiendo las reglas ECONEURA v2025-09-05.
...
### **apps/api/src/controllers/health.ts**
```typescript
...
import { authRequestSchema, refreshTokenSchema } from '@econeura/shared/auth/types';
...
## 📊 **Endpoints de Usuarios y Organizaciones**
