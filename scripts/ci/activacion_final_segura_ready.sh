...
NEW_HEX_64="d345dfc71b1f99b0eb9b0a347c9ea76799862de2360765763ce51439a0401d0b"
...
echo "$NEW_HEX_64" | gh secret set VAULT_APPROVAL_KEY || fail "No se pudo setear secret en GitHub"
