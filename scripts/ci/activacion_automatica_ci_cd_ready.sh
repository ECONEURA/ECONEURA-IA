...
VAULT_APPROVAL_KEY="e13f82e638c107f2f56370009598ddfbba96b25fc299003a9bc683e462ae7cdb"
...
echo "$VAULT_APPROVAL_KEY" | gh secret set VAULT_APPROVAL_KEY || fail "Failed to set secret"
