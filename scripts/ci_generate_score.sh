...
# ci_generate_score.sh
# Generates `artifacts/pnpm-audit.json` and `artifacts/score.json`.
...
# Enable corepack/pnpm if available
...
if command -v pnpm >/dev/null 2>&1; then
  ...
  # If the audit produced a file, try to compute a simple score
