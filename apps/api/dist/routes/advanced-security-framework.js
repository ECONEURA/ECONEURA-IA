...
router.post('/rbac/assign-role', async (req, res) => {
    try {
        ...
        const result = await advancedSecurityFramework.assignRole(validatedData.userId, validatedData.role, validatedData.assignedBy);
...
router.post('/compliance/check', async (req, res) => {
    try {
        ...
        const result = await advancedSecurityFramework.checkCompliance(validatedData.organizationId, validatedData.complianceType);
...
//# sourceMappingURL=advanced-security-framework.js.map