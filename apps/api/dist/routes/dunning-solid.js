...
const createSegmentSchema = z.object({
    ...
    strategy: z.object({
        ...
        retryInterval: z.number().min(1).max(168),
...
const updateConfigSchema = z.object({
    ...
    kpiCalculationInterval: z.number().min(1).max(1440).optional(),
...
router.post('/dlq', async (req, res) => {
    try {
        ...
        const organizationId = req.user?.organizationId || 'default-org';
        const dlqMessage = await dunningSolidService.addToDLQ(validatedData.originalMessageId, validatedData.queueName, validatedData.messageType, validatedData.payload, validatedData.failureReason, organizationId, validatedData.priority);
...
//# sourceMappingURL=dunning-solid.js.map