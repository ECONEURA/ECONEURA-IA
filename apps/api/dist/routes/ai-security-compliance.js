...
router.post('/policies', validateRequest(CreateSecurityPolicySchema), async (req, res) => {
    try {
...
router.put('/policies/:id', validateRequest(UpdateSecurityPolicySchema), async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/compliance/check', validateRequest(RunComplianceCheckSchema), async (req, res) => {
    try {
...
router.post('/incidents', validateRequest(CreateSecurityIncidentSchema), async (req, res) => {
    try {
...
router.post('/evaluate', validateRequest(EvaluateAISecuritySchema), async (req, res) => {
    try {
...
router.post('/reports', validateRequest(GenerateComplianceReportSchema), async (req, res) => {
    try {
        const { organizationId, reportType, period } = req.body;
        const report = await aiSecurityComplianceService.generateComplianceReport(organizationId, reportType, {
...
//# sourceMappingURL=ai-security-compliance.js.map