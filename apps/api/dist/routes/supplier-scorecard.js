...
supplierScorecardRouter.post('/reports', async (req, res) => {
    try {
        ...
        const report = await supplierScorecardService.generateSupplierReport(reportData.organizationId, reportData.reportType, reportData.startDate, reportData.endDate, reportData.generatedBy);
        res.status(201).json({
            success: true,
            data: report,
            timestamp: new Date().toISOString()
...
//# sourceMappingURL=supplier-scorecard.js.map