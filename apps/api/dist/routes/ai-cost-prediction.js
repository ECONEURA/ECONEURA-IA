...
router.post('/models', validateRequest(CreatePredictionModelSchema), async (req, res) => {
    try {
...
router.post('/models/:id/train', validateRequest(TrainModelSchema), async (req, res) => {
    try {
        const { id } = req.params;
        const { trainingData } = req.body;
        const processedTrainingData = {
            ...trainingData,
            historicalData: trainingData.historicalData.map((item) => ({
                ...item,
...
router.post('/predict', validateRequest(GeneratePredictionSchema), async (req, res) => {
    try {
...
router.post('/forecast', validateRequest(GenerateForecastSchema), async (req, res) => {
    try {
...
router.get('/compare', async (req, res) => {
    try {
        ...
        const modelIds = models ? models.split(',') : [];
...
//# sourceMappingURL=ai-cost-prediction.js.map