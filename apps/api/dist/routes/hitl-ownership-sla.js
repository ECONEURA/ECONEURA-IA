...
hitlOwnershipSLARouter.post('/reports', async (req, res) => {
    try {
        ...
        const report = await hitlOwnershipSLAService.generateReport(reportData.organizationId, reportData.reportType, reportData.startDate, reportData.endDate, reportData.generatedBy);
        res.status(201).json({
            success: true,
            data: report,
            timestamp: new Date().toISOString()
...
//# sourceMappingURL=hitl-ownership-sla.js.map