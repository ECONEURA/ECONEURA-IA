...
router.put('/violations/:id', async (req, res) => {
    ...
    try {
        ...
        const violation = await advancedAuditComplianceService.updateViolationStatus(id, updateData.status, updateData.resolution, updateData.assignedTo);
...
//# sourceMappingURL=advanced-audit-compliance.js.map