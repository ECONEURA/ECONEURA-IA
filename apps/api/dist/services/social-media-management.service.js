...
export class SocialMediaManagementService {
    ...
    async initializeSocialMediaTables() {
        await this.db.query(`
    ...
    async createPost(organizationId, postData, createdBy) {
        try {
    ...
    async getPost(postId, organizationId) {
        try {
    ...
    async searchPosts(organizationId, searchParams) {
        try {
            ...
            if (searchParams.filters) {
                ...
                if (searchParams.filters.tags) {
                    posts = posts.filter(post => searchParams.filters.tags.some(tag => post.tags.includes(tag)));
                }
    ...
    async getSocialMediaStatistics(organizationId) {
        try {
...
//# sourceMappingURL=social-media-management.service.js.map