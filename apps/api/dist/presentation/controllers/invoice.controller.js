...
export class InvoiceController extends BaseController {
    ...
    async createInvoice(req, res, next) {
        await this.handleAsync(async () => {
            ...
            const response = this.transformInvoiceToResponse(result.data.invoice);
    ...
    async getInvoice(req, res, next) {
        await this.handleAsync(async () => {
            ...
            const response = this.transformInvoiceToResponse(invoice);
            this.sendSuccessResponse(res, response);
        }, res, next);
    }
    async getInvoicesByOrganization(req, res, next) {
        await this.handleAsync(async () => {
    ...
    async getInvoicesByType(req, res, next) {
        await this.handleAsync(async () => {
            const { organizationId } = InvoiceOrganizationIdParamSchema.parse(req.params);
    ...
    async getInvoicesByPaymentStatus(req, res, next) {
        await this.handleAsync(async () => {
            const { organizationId } = InvoiceOrganizationIdParamSchema.parse(req.params);
    ...
    async getInvoicesByCompany(req, res, next) {
        await this.handleAsync(async () => {
            const { organizationId } = InvoiceOrganizationIdParamSchema.parse(req.params);
    ...
    async getInvoicesDueSoon(req, res, next) {
        await this.handleAsync(async () => {
            const { organizationId } = InvoiceOrganizationIdParamSchema.parse(req.params);
    ...
    async recordPayment(req, res, next) {
        await this.handleAsync(async () => {
            ...
            invoice.recordPayment({ amount: requestData.amount.amount, currency: requestData.amount.currency }, requestData.paymentMethod, requestData.paidDate);
            const updatedInvoice = await this.invoiceRepository.update(invoice);
            const response = this.transformInvoiceToResponse(updatedInvoice);
    ...
    async bulkUpdateInvoices(req, res, next) {
        await this.handleAsync(async () => {
    ...
    transformInvoiceToResponse(invoice) {
        return {
            id: invoice.id.value,
