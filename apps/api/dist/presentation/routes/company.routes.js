...
import { z } from 'zod';
export const createCompanyRoutes = (companyController) => {
    const router = Router();
    ...
    router.put('/:companyId', validateRequest({
        params: z.object({
    ...
    router.delete('/:companyId', validateRequest({
        params: z.object({
            companyId: z.string().uuid()
        })
    }), companyController.deleteCompany.bind(companyController));
    router.get('/:companyId', validateRequest({
        params: z.object({
            companyId: z.string().uuid()
        })
