...
class InventoryKardexService {
    ...
    async createKardexEntry(entryData) {
        const now = new Date().toISOString();
        const newEntry = {
    ...
    async getKardexEntries(organizationId, filters = {}) {
    ...
    async getStockLevels(organizationId, filters = {}) {
    ...
    async createCycleCount(cycleCountData) {
        const now = new Date().toISOString();
        const newCycleCount = {
    ...
    async getCycleCounts(organizationId, filters = {}) {
    ...
    async completeCycleCount(cycleCountId, actualQuantity, notes) {
    ...
    async generateInventoryReport(organizationId, reportType, startDate, endDate, generatedBy) {
        let summary = {};
        let data = {};
        switch (reportType) {
            case 'stock_levels': {
...
//# sourceMappingURL=inventory-kardex.service.js.map