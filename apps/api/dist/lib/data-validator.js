...
export class DataValidator {
    ...
    async validateField(rule, value, allData) {
        const errors = [];
    ...
    updateStats(success, duration, errors) {
    ...
    recordValidation(schemaName, success, duration, errors) {
    ...
    recordMetrics(schemaName, success, duration) {
        if (success) {
