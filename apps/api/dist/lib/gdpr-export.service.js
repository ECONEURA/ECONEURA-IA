...
export class GDPRExportService {
    ...
    async createExportRequest(userId, requestedBy, dataCategories, format = 'zip', scope = 'user') {
        try {
    ...
    validateDataCategories(categoryIds) {
        return categoryIds
...
//# sourceMappingURL=gdpr-export.service.js.map