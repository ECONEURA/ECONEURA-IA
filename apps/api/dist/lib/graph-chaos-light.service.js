...
class GraphChaosLightService {
    ...
    constructor() {
        this.config = {
            ...
            rotationIntervalMs: Number(process.env.GRAPH_CHAOS_ROTATION_INTERVAL || 30000),
            failureRate: Number(process.env.GRAPH_CHAOS_FAILURE_RATE || 0.1),
            latencyMs: {
    ...
    async simulateGraphApiCall(endpoint, method = 'GET') {
...
//# sourceMappingURL=graph-chaos-light.service.js.map