...
// Cache manager is imported as advancedCacheManager
...
app.post("/v1/cache/warmup", (req, res) => {
  try {
    advancedCacheManager.warmupAll();
    res.json({
      success: true,
      data: {
...
app.post("/v1/cache/warmup/start", (req, res) => {
  try {
    ...
    advancedCacheManager.startPeriodicWarmup(intervalMinutes);
    res.json({
      success: true,
      data: {
...
app.post("/v1/cache/warmup/stop", (req, res) => {
  try {
    advancedCacheManager.stopPeriodicWarmup();
    res.json({
      success: true,
      data: {
...
app.delete("/v1/cache/ai", (req, res) => {
  try {
    advancedCacheManager.getAICache().clear();
    res.json({
      success: true,
      data: {
...
app.delete("/v1/cache/search", (req, res) => {
  try {
    advancedCacheManager.getSearchCache().clear();
    res.json({
      success: true,
      data: {
