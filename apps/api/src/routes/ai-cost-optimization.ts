...
// POST /v1/ai-cost-optimization/analyze - Generar análisis de costos
router.post('/analyze',
  validateRequest(GenerateCostAnalysisSchema),
  async (req, res) => {
    try {
...
// GET /v1/ai-cost-optimization/trends - Obtener tendencias de costos
...
router.post('/optimize',
  validateRequest(OptimizeCostsSchema),
  async (req, res) => {
    try {
...
// GET /v1/ai-cost-optimization/metrics - Obtener métricas de costos
...
// GET /v1/ai-cost-optimization/models - Obtener información de modelos
