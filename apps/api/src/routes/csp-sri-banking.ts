...
// Schema de validación para reportes CSP
...
// Schema de validación para reportes SRI
...
// Schema para resolución de reportes
 ...
 * Endpoint para recibir reportes de violaciones CSP/SRI
 */
router.post('/csp-reports', async (req: Request, res: Response) => {
  try {
    ...
    if (req.body['csp-report']) {
      ...
      res.status(204).send(); // No Content - estándar para report-uri
 ...
 * Obtiene reportes de violaciones con filtros
 */
router.get('/csp-reports', async (req: Request, res: Response) => {
  try {
...
/**
 * GET /api/security/csp-reports/stats
 * Obtiene estadísticas de violaciones
 */
router.get('/csp-reports/stats', async (req: Request, res: Response) => {
  try {
...
/**
 * GET /api/security/csp-reports/:reportId
 * Obtiene un reporte específico
 */
router.get('/csp-reports/:reportId', async (req: Request, res: Response) => {
  try {
...
/**
 * PATCH /api/security/csp-reports/:reportId/resolve
 * Marca un reporte como resuelto
 */
router.patch('/csp-reports/:reportId/resolve', async (req: Request, res: Response) => {
  try {
    const { reportId } = req.params;
...
/**
 * GET /api/security/csp-policy
 * Obtiene la política CSP actual
 */
router.get('/csp-policy', async (req: Request, res: Response) => {
  try {
...
/**
 * POST /api/security/csp-policy
 * Actualiza la configuración CSP
 */
router.post('/csp-policy', async (req: Request, res: Response) => {
  try {
...
/**
 * POST /api/security/sri-hashes
 * Genera hashes SRI para recursos
 */
router.post('/sri-hashes', async (req: Request, res: Response) => {
  try {
...
/**
 * POST /api/security/csp-reports/cleanup
 * Limpia reportes antiguos
 */
router.post('/csp-reports/cleanup', async (req: Request, res: Response) => {
  try {
...
/**
 * POST /api/security/csp-reports/reset
 * Reinicia el servicio de reportes
 */
router.post('/csp-reports/reset', async (req: Request, res: Response) => {
  try {
