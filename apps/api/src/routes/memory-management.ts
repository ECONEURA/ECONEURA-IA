...
/**
 * GET /memory/status
 * Obtiene el estado actual del sistema de gestión de memoria
 */
 ...
 * Fuerza una optimización manual de memoria
 */
...
/**
 * PUT /memory/config
 * Actualiza la configuración del gestor de memoria
 */
...
/**
 * GET /memory/leaks
 * Obtiene información sobre memory leaks detectados
 */
...
/**
 * GET /memory/gc-history
 * Obtiene el historial de garbage collection
 */
...
/**
 * GET /memory/health
 * Health check específico para el sistema de gestión de memoria
 */
router.get('/health', async (req, res) => {
  ...
  try {
    ...
    const healthChecks = {
      ...
      gc: status.metrics.gc.lastGC > Date.now() - 300000 // Último GC hace menos de 5 minutos
    };
 ...
 * Obtiene recomendaciones de optimización de memoria
 */
