...
// GET /v1/stripe/receipts - Get receipts with filters
...
// GET /v1/stripe/receipts/:id - Get specific receipt
...
// POST /v1/stripe/receipts - Create new receipt
...
// POST /v1/stripe/webhooks - Process Stripe webhook
...
// POST /v1/stripe/receipts/:id/reconcile - Manually reconcile receipt
...
// POST /v1/stripe/receipts/:id/auto-reconcile - Trigger auto-reconciliation
...
// GET /v1/stripe/reconciliation-rules - Get reconciliation rules
...
// POST /v1/stripe/reconciliation-rules - Create reconciliation rule
...
// POST /v1/stripe/reports/reconciliation - Generate reconciliation report
stripeReceiptsRouter.post('/reports/reconciliation', async (req, res) => {
  try {
    const reportData = GenerateReportSchema.parse(req.body);
    const report = await stripeReceiptsService.generateReconciliationReport(
...
// GET /v1/stripe/stats - Get reconciliation statistics
...
// GET /v1/stripe/health - Health check
