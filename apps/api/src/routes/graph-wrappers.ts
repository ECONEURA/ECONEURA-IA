...
// GET /v1/graph/users/:userId - Get specific user
...
// GET /v1/graph/messages - Get messages
...
// GET /v1/graph/calendar/events - Get calendar events
...
// GET /v1/graph/drive/items - Get drive items
...
// GET /v1/graph/teams/:teamId/channels - Get team channels
...
// POST /v1/graph/outbox - Add message to outbox
...
// GET /v1/graph/outbox - Get outbox messages
...
// POST /v1/graph/outbox/:messageId/send - Send outbox message
...
// POST /v1/graph/outbox/:messageId/cancel - Cancel outbox message
