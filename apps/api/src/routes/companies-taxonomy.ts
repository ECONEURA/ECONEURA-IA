/**
 * PR-51: Companies Taxonomy & Views Routes
 */
...
/**
 * GET /companies-taxonomy/taxonomies
 * Obtiene todas las taxonomías disponibles
 */
...
/**
 * POST /companies-taxonomy/classify
 * Clasifica una empresa usando las taxonomías disponibles
 */
...
/**
 * GET /companies-taxonomy/views/:organizationId
 * Obtiene todas las vistas de una organización
 */
...
/**
 * GET /companies-taxonomy/views/:organizationId/:viewId/companies
 * Obtiene empresas filtradas por vista
 */
router.get('/views/:organizationId/:viewId/companies', async (req, res) => {
  ...
  try {
    ...
    const result = await companiesTaxonomyService.getCompaniesByView(
      viewId,
      organizationId,
      {
...
/**
 * GET /companies-taxonomy/health
 * Health check del servicio de taxonomía
 */
