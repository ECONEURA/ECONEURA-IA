...
export const createContactRoutes = (contactController: ContactController): Router => {
  ...
  // GET /contacts/organization/:organizationId - Get contacts by organization
  ...
  // GET /contacts/company/:companyId - Get contacts by company
  ...
  // GET /contacts/organization/:organizationId/search - Search contacts
  ...
  // ========================================================================
  // CONTACT STATISTICS ROUTES
  // ========================================================================

  // GET /contacts/organization/:organizationId/stats - Get contact statistics
  ...
  // ========================================================================
  // CONTACT FILTER ROUTES
  // ========================================================================

  // GET /contacts/organization/:organizationId/type/:type - Get contacts by type
  ...
  // GET /contacts/organization/:organizationId/status/:status - Get contacts by status
  ...
  // GET /contacts/organization/:organizationId/department/:department - Get contacts by department
  router.get('/organization/:organizationId/department/:department',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid(),
        department: z.string()
  ...
  // GET /contacts/organization/:organizationId/industry/:industry - Get contacts by industry
  ...
  // GET /contacts/organization/:organizationId/assigned/:userId - Get contacts by assigned user
  ...
  // GET /contacts/organization/:organizationId/overdue-follow-up - Get contacts overdue for follow-up
  ...
  // GET /contacts/organization/:organizationId/scheduled-follow-up/:date - Get contacts scheduled for follow-up
  ...
  // GET /contacts/organization/:organizationId/high-score-leads - Get high score leads
  ...
  // GET /contacts/organization/:organizationId/medium-score-leads - Get medium score leads
  ...
  // GET /contacts/organization/:organizationId/low-score-leads - Get low score leads
  ...
  // GET /contacts/organization/:organizationId/highly-engaged - Get highly engaged contacts
  router.get('/organization/:organizationId/highly-engaged',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      }),
  ...
  // GET /contacts/organization/:organizationId/moderately-engaged - Get moderately engaged contacts
  router.get('/organization/:organizationId/moderately-engaged',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // GET /contacts/organization/:organizationId/low-engaged - Get low engaged contacts
  router.get('/contacts/organization/:organizationId/low-engaged',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // ========================================================================
  // BIRTHDAY AND ANNIVERSARY ROUTES
  // ========================================================================

  // GET /contacts/organization/:organizationId/birthday-today - Get contacts with birthday today
  router.get('/organization/:organizationId/birthday-today',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // GET /contacts/organization/:organizationId/birthday-this-week - Get contacts with birthday this week
  router.get('/organization/:organizationId/birthday-this-week',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // GET /contacts/organization/:organizationId/birthday-this-month - Get contacts with birthday this month
  router.get('/organization/:organizationId/birthday-this-month',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // GET /contacts/organization/:organizationId/anniversary-today - Get contacts with anniversary today
  router.get('/organization/:organizationId/anniversary-today',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // GET /contacts/organization/:organizationId/anniversary-this-week - Get contacts with anniversary this week
  router.get('/organization/:organizationId/anniversary-this-week',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // GET /contacts/organization/:organizationId/anniversary-this-month - Get contacts with anniversary this month
  router.get('/organization/:organizationId/anniversary-this-month',
    validateRequest({
      params: z.object({
        organizationId: z.string().uuid()
      })
  ...
  // PUT /contacts/bulk/update - Bulk update contacts
