...
export const validateCreateCompanyRequest = (data: unknown): CreateCompanyRequest => {
  return CreateCompanyRequestSchema.parse(data);
};

export const validateUpdateCompanyRequest = (data: unknown): UpdateCompanyRequest => {
  return UpdateCompanyRequestSchema.parse(data);
};

export const validateDeleteCompanyRequest = (data: unknown): DeleteCompanyRequest => {
  return DeleteCompanyRequestSchema.parse(data);
};

export const validateGetCompanyRequest = (data: unknown): GetCompanyRequest => {
  return GetCompanyRequestSchema.parse(data);
};

export const validateSearchCompaniesRequest = (data: unknown): SearchCompaniesRequest => {
  return SearchCompaniesRequestSchema.parse(data);
};

export const validateBulkUpdateCompaniesRequest = (data: unknown): BulkUpdateCompaniesRequest => {
  return BulkUpdateCompaniesRequestSchema.parse(data);
};

export const validateBulkDeleteCompaniesRequest = (data: unknown): BulkDeleteCompaniesRequest => {
...
export const transformCompanyToResponse = (company: any): CompanyResponse => {
  return {
    id: company.id,
...
export const transformCompanyListToResponse = (companyList: any): CompanyListResponse => {
  return {
...
export const transformCompanyStatsToResponse = (stats: any): CompanyStatsResponse => {
  return {
    total: stats.total,
    byType: stats.byType,
