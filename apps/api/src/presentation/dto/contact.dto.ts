...
export const validateUpdateContactRequest = (data: unknown): UpdateContactRequest => {
  return UpdateContactRequestSchema.parse(data);
};

export const validateDeleteContactRequest = (data: unknown): DeleteContactRequest => {
  return DeleteContactRequestSchema.parse(data);
};

export const validateGetContactRequest = (data: unknown): GetContactRequest => {
  return GetContactRequestSchema.parse(data);
};

export const validateSearchContactsRequest = (data: unknown): SearchContactsRequest => {
  return SearchContactsRequestSchema.parse(data);
};

export const validateBulkUpdateContactsRequest = (data: unknown): BulkUpdateContactsRequest => {
  return BulkUpdateContactsRequestSchema.parse(data);
};

export const validateBulkDeleteContactsRequest = (data: unknown): BulkDeleteContactsRequest => {
...
export const transformContactToResponse = (contact: any): ContactResponse => {
  return {
    id: contact.id,
...
export const transformContactListToResponse = (contactList: any): ContactListResponse => {
  return {
...
export const transformContactStatsToResponse = (stats: any): ContactStatsResponse => {
  return {
    total: stats.total,
    byType: stats.byType,
