...
export const validateCreateOrganizationRequest = (data: unknown): CreateOrganizationRequest => {
  return CreateOrganizationRequestSchema.parse(data);
};

export const validateUpdateOrganizationRequest = (data: unknown): UpdateOrganizationRequest => {
  return UpdateOrganizationRequestSchema.parse(data);
};

export const validateDeleteOrganizationRequest = (data: unknown): DeleteOrganizationRequest => {
  return DeleteOrganizationRequestSchema.parse(data);
};

export const validateGetOrganizationRequest = (data: unknown): GetOrganizationRequest => {
  return GetOrganizationRequestSchema.parse(data);
};

export const validateSearchOrganizationsRequest = (data: unknown): SearchOrganizationsRequest => {
...
export const transformOrganizationToResponse = (organization: any): OrganizationResponse => {
  return {
    id: organization.id,
...
export const transformOrganizationListToResponse = (organizationList: any): OrganizationListResponse => {
  return {
...
export const transformOrganizationStatsToResponse = (stats: any): OrganizationStatsResponse => {
  return {
    total: stats.total,
