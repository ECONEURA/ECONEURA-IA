...
export interface InventoryKardexRepository extends BaseRepository<InventoryKardex> {
  ...
  adjustStockMany(adjustments: Array<{ id: string; quantity: number; unitCost: any; reason: string }>): Promise<void>;
  ...
  getStockTurnoverAnalysis(organizationId: string, periodDays: number = 365): Promise<{
